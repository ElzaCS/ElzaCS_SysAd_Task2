...
<body>
<p>welcome to web-02 example webpage</p>
<?php
...
// get current processes from table Requests
 ...
 $sqlcurr = "select * from Requests where Name='Node2' and addtime(Starttime,sec_to_time(reqtime))>now();";
...
echo "<h2>History</h2>";
 $sqlold = "select * from Requests where Name='Node2' and addtime(Starttime,sec_to_time(reqtime))<now();";
